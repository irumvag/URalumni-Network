...
<body>
    ...
    <div class="header2" align="center">
        <ul class="centered">
            ...
            <LI class="backg"><a href="events.php"><i class="fa-solid fa-champagne-glasses"style="font-size: 20px;"></i>Event</a></LI>
    ...
    <hr width="98%" style="margin-bottom: 0;padding-bottom: 0;font-size: large;"/>
    <main>
      <p align="center"> <h1>University of Rwanda Alumni events</h1></p> 
        <div class="all_events">
          <div class="event1">
            <h1>Alumni network launching</h1>
            <P>UR Alumni network event will take place at Camp KIGALI MUHAZI temt on 06<sup>th</sup> may 2024. There we will be with Alumni,principles of UR Campus,alumni association leader,lectures and final year student.
             we will be launching UR alumni network website and they will be discussing how to use that website more effective.The majority of this event is launching UR alumni network and sharing testmony on after academic journal with alumni <a href="#">Read more...</a></P>
             <p><a href=""><u>R</u>egist here!</a></p>
          </div>  
          <div class="event2">
            <h1>Effective Platform Use</h1>
            <P>Effective platform use of UR alumni network website event will be conductive via online through zoom meeting on 20<sup>th</sup> july 2024.There we will be with alumni who are willing to use alumni network effective so that it can 
            become source of knowledge and skill sharing. we will be talking about how to use website by sharing news, how to create post how to get information about opportunities,mentorship programs and many content in UR alumni network web site<a href="#">Read more...</a> </P>
            <p><a href=""><u>R</u>egist here!</a></p>
        </div>  
          <div class="event3">
            <h1>Alumni network launching</h1>
    ...
    <div class="footer-all">
        ...
        <div class="footer-col2">
            <H1>KEY Links</H1>
            <a href="alumni.php"><i class="fa-solid fa-house"></i>Home</a><br><br><br>
        ...
        <div class="footer-col3">
            <h1>News letter from Alumni</H1><br><br><br>
                <form action="newletter.php"method="post" align="center">
                    ...
                    <button type="submit"onclick="agreed()" style="font-size: 30px;background: transparent;color: dodgerblue;">Subscribe</button>
                </form>
                <p id="timming"></p>
        </div>
        <div class="footer-col3">
    ...
    <p id="copy" align="center"></p>
<script>
    function agreed()
    {
    var c=confirm("Thanks we look forwarding to hear your feedback!!");
    if(c=true)
    alert("You will be recievind news letter from  UR alumni");
    else
    alert("you will not be recieving news letter.");
    }
