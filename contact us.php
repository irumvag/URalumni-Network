 ...
 <main>
    <div class="col1">
     <a href="profile.php"><div class="home"></i></i>Overview</div></a>
        ...
        <a href="messages.php"><div class="home"><i class="fa-solid fa-people-robbery" style="color: #241f31;"></i>Messages</div></a>
    ...
    <div class="col2">
      <div class="side1">
        <img src="pic/gad.png" alt="head of alumni association">
        <h1>Have a question about your alumni network?</h1>
        <p>via Email:irumvagadanaclet@gmail.com</p>
        <p>vai Phone: +250789696664</p>
      </div>
      <div class="side2">
        <p>Learn more about your Alumni resources </p>
      </div>
    </div>
 </main>
 <hr>
