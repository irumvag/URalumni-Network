 ...
 <main>
    ...
    <div class="col2">
      ...
      <form class="form" action="<?php htmlspecialchars($_SERVER['PHP_SELF']);?>" method="post">
        ...
        <label for="message">Message:<b id="red">*</b></label>
